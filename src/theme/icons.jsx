...
export function IconRoom({ size, color = "#555", className, style }) {
    return (
        <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" fill={color} width={size} className={className} style={style} >
            <g strokeLinecap="round" strokeLinejoin="round"></g>
            <path fill={color} d="M440,424V88H352V13.005L88,58.522V424H16v32h86.9L352,490.358V120h56V456h88V424ZM320,453.642,120,426.056V85.478L320,51Z" />
            <rect width="32" height="64" x="256" y="232" fill={color} />
        </svg>
    )
}

export function IconFuelType({ size, color = "#555", className, style }) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="-15.36 -15.36 542.72 542.72" width={size} className={className} style={style} >

            <path d="M22 10.2325V15.8834C22 18.7668 22 20.2085 21.1213 21.1042C20.2426 22 18.8284 22 16 22H8C5.17157 22 3.75736 22 2.87868 21.1042C2 20.2085 2 18.7668 2 15.8834V13.0869C2 10.9906 2 9.94241 2.55325 9.14745C3.1065 8.3525 4.07697 8.00623 6.0179 7.3137L14.0179 4.45927C17.6539 3.16195 19.4718 2.51329 20.7359 3.42756C21.4239 3.92513 21.7374 4.73349 21.8803 6" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
            <path d="M9 14C9 12.5858 9 11.8787 9.43934 11.4393C9.87868 11 10.5858 11 12 11C13.4142 11 14.1213 11 14.5607 11.4393C15 11.8787 15 12.5858 15 14C15 15.4142 15 16.1213 14.5607 16.5607C14.1213 17 13.4142 17 12 17C10.5858 17 9.87868 17 9.43934 16.5607C9 16.1213 9 15.4142 9 14Z" stroke={color} strokeWidth="1.5" />
            <path d="M15 11L16 10" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
            <path d="M9 11L8 10" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
            <path d="M15 17L16 18" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
            <path d="M9 17L8 18" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
            <path d="M5 7.06009C5 5.75506 5 5.10254 5.33815 4.65303C5.4252 4.53731 5.52676 4.43372 5.64021 4.34492C6.08089 4 6.7206 4 8 4H8.81818C9.32544 4 9.57907 4 9.78716 4.05687C10.3519 4.21122 10.7929 4.66113 10.9442 5.23713" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
        </svg>
    )
}
...
export function IconTime({ size, color, className, style }) {
    return (
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width={size} className={className} style={style} >
            <path d="M23 12C23 18.0751 18.0751 23 12 23C5.92487 23 1 18.0751 1 12C1 5.92487 5.92487 1 12 1C18.0751 1 23 5.92487 23 12ZM3.00683 12C3.00683 16.9668 7.03321 20.9932 12 20.9932C16.9668 20.9932 20.9932 16.9668 20.9932 12C20.9932 7.03321 16.9668 3.00683 12 3.00683C7.03321 3.00683 3.00683 7.03321 3.00683 12Z" fill={color} ></path>
            <path d="M12 5C11.4477 5 11 5.44771 11 6V12.4667C11 12.4667 11 12.7274 11.1267 12.9235C11.2115 13.0898 11.3437 13.2343 11.5174 13.3346L16.1372 16.0019C16.6155 16.278 17.2271 16.1141 17.5032 15.6358C17.7793 15.1575 17.6155 14.5459 17.1372 14.2698L13 11.8812V6C13 5.44772 12.5523 5 12 5Z" fill={color} ></path>
        </svg>
    )
}
export function IconAsk({ size, color, className, style }) {
    return (
        <svg version="1.1" viewBox="-0.96 -0.96 33.92 33.92" fill={color} stroke={color} width={size} className={className} style={style} transform="rotate(0)">
            <path d="M14.197,2.113C7.871,2.903,2.796,8.062,2.09,14.398c-0.387,3.47,0.502,6.716,2.248,9.342l-2.059,4.632 c-0.168,0.378-0.086,0.821,0.207,1.113l0.029,0.029c0.293,0.293,0.735,0.375,1.113,0.207l4.632-2.059 c2.626,1.747,5.872,2.635,9.342,2.248c6.336-0.706,11.495-5.782,12.285-12.108C31.029,8.658,23.342,0.971,14.197,2.113z M16,28.923 c-2.551,0-5.021-0.746-7.144-2.158l-0.493-0.328l-5.042,2.241l2.241-5.042l-0.328-0.493C3.823,21.021,3.077,18.551,3.077,16 C3.077,8.874,8.874,3.077,16,3.077c7.126,0,12.923,5.797,12.923,12.923S23.126,28.923,16,28.923z M15,21.5L15,21.5 c0-0.277,0.224-0.5,0.5-0.5H15.5c0.276,0,0.5,0.224,0.5,0.5V21.5c0,0.276-0.224,0.5-0.5,0.5H15.5C15.224,22,15,21.776,15,21.5z M15,19.5v-2.603c0-0.22,0.178-0.398,0.398-0.398h0.001c1.882,0,3.504-1.443,3.597-3.323C19.095,11.167,17.488,9.5,15.5,9.5 c-1.624,0-2.994,1.113-3.387,2.616c-0.058,0.224-0.254,0.384-0.485,0.384h0c-0.328,0-0.567-0.311-0.485-0.628 c0.52-2.005,2.39-3.471,4.577-3.366c2.119,0.102,3.916,1.725,4.229,3.823c0.358,2.401-1.247,4.612-3.55,5.081L16,17.491V19.5 c0,0.276-0.224,0.5-0.5,0.5H15.5C15.224,20,15,19.776,15,19.5z" />
        </svg>
    )
}
...
export function IconEdit({ size,  color = "#555", className, style }) {
    return (
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill={"none"} width={size} className={className} style={style}    >
